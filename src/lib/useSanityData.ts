...
export const QUERIES = {
  ...
  studentLife: `*[_type == "studentLife"][0]{ ..., "heroImageUrl": hero.image.asset->url }`,
  studentLifeGallery: `*[_type == "studentLife"][0].successGallery[]{ alt, caption, "imageUrl": image.asset->url }`,
