          ...
          {displayPrograms.map((project, index) => (
            ...
            >
              ...
              >
                ...
                {/* Hover gradient */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D1B2A]/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
