  ...
  return (
    ...
    >
      ...
      <div ref={carouselRef} className="relative opacity-0">
        ...
        <div className="absolute top-0 left-0 w-24 h-full bg-gradient-to-r from-offwhite to-transparent z-10 pointer-events-none" />
        <div className="absolute top-0 right-0 w-24 h-full bg-gradient-to-l from-offwhite to-transparent z-10 pointer-events-none" />
      </div>
